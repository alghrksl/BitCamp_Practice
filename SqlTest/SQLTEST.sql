...
SELECT
ENAME, SAL, SAL*12+100 as YEARSAL
 FROM emp
...
SELECT
    ENAME, DEPTNO
FROM EMP
WHERE SAL >= 2000 and SAL <= 3000; AND (DEPT = 2O OR DEPT = 30);
...
ENAME, SAL , JOB
FROM EMP
WHERE (JOB = 'CLERK' OR JOB = 'SALEMAN') AND (SAL != '1600' OR SAL != '950' OR SAL != '1300');
